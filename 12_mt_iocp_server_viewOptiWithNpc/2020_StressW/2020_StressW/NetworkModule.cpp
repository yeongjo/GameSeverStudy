...
void Test_Thread()
{
	while (true) {
		...
		for (int i = 0; i < num_connections; ++i) {
			...
			if (g_clients[i].last_move_time + 1.0s > high_resolution_clock::now()) continue;
			...
			case 1: my_packet.dr = D_E; break;
			case 2: my_packet.dr = D_S; break;
